...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">Tim pengelola Sport Venues Rental Website</p>
               </div>
          </div>
     </section>
     ...
     <section id="team" class="section-background">
          <div class="container">
               <div class="row">
                    <div class="col-md-4 col-sm-4" >
                         <div class="team-thumb">
                              ...
                              <div class="team-info">
                                   <h3>Fadillah Willis Triyayuda</h3>
                                   <span>162012133074</span>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb">
                              ...
                              <div class="team-info">
                                   <h3>Atara Loveana Wijaya</h3>
                                   <span>162112133005</span>
                              </div>
                              <ul class="social-icon">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb">
                              ...
                              <div class="team-info">
                                   <h3>Davano Al Raffi Abdul Jabbar</h3>
                                   <span>162112133083</span>
                              </div>
                              <ul class="social-icon">
                                   <li><a href="#" class="fa fa-twitter"></a></li>
               ...
               <div class="row">
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb-2">
                              <div class="team-image">
                                   <img src="images/author-image-4-646x680.jpg" class="img-responsive" alt="">
                              </div>
                              <div class="team-info">
                                   <h3>Syahlla Muthi Huwaida</h3>
                                   <span>162112133104</span>
                              </div>
                              <ul class="social-icon">
                                   <li><a href="#" class="fa fa-twitter"></a></li>
                                   <li><a href="#" class="fa fa-envelope-o"></a></li>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="team-thumb-2">
                              ...
                              <div class="team-info">
                                   <h3>Muhammad Rowahul Muslim</h3>
                                   <span>162112133117</span>
                              </div>
                              <ul class="social-icon">
                                   <li><a href="#" class="fa fa-twitter"></a></li>
                                   <li><a href="#" class="fa fa-google"></a></li>
