...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li  class="active"><a href="{{url('/gym')}}">Venue Gym</a></li>
                         <li class="dropdown">
     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">Sewa venue gym favorit anda sekarang juga!</p>
               </div>
          </div>
     </section>
     ...
     <section class="section-background">
          <div class="container">
               <div class="row">
                    @foreach($gym as $key => $data)
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   <div class="courses-image">
                                        <img src="{{ asset('storage/' . $data->image_gym) }}" class="img-responsive" alt="" style="width: 800px;height:300px;">
                                   </div>
