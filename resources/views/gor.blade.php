...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li class="active"><a href="{{url('/gor')}}">Venue GOR</a></li>
     ...
     <section>
          <div class="container">
               <div class="text-center">
                    ...
                    <p class="lead">Berikut beberapa venue Gelanggang Olah Raga (GOR) yang dapat anda sewa</p>
               </div>
          </div>
     </section>
     ...
     <section class="section-background">
          <div class="container">
               <div class="row">
                    @foreach($gor as $key => $data)
                    <div class="col-md-4 col-sm-4">
                         <div class="courses-thumb courses-thumb-secondary">
                              <div class="courses-top">
                                   <div class="courses-image">
                                        <img src="{{ asset('storage/' . $data->image_gor) }}" class="img-responsive" alt="" style="width: 800px;height:300px;">
                                   </div>
                              ...
                              <div class="courses-detail">
                                   <h3><a href="fleet.html">{{$data->nama}}</a></h3>
                                   <p class="lead"><small>Harga Sewa dari</small> <strong>{{$data->price}}</strong> <small>per jam</small></p>
                                   {!! $data->description !!}
                              </div>
